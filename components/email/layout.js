...
export default ({ children, hiddenText }) => {
  ...
  return (
    <ThemeProvider theme={theme}>
      <html style={{ background: theme.colors.pink, width: '100%' }} lang="en">
        <GlobalStyles />
        <body>
          {hiddenText && (
            <>
              <div style={{ display: 'none', maxHeight: '0px', overflow: 'hidden' }}>{hiddenText}</div>
          ...
          <Container fontSize="16px" width={1}>
            <Row>
